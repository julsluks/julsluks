...
🔹 **Disponibilidad:** Remoto | Híbrido | Presencial (Barcelona)  

*"Me encanta transformar ideas complejas en productos intuitivos que marquen diferencia"*

[![Portafolio](https://img.shields.io/badge/Portafolio-2D2D2D?style=for-the-badge&logo=internet-explorer&logoColor=white)](https://www.julievill.dev/)
...
🧠 **Aprendizaje continuo** - Certificada en DAM y DAW  
⚡ **Liderazgo técnico** - Guiando equipos desde 2023  
✨ **Código limpio** - Fanática de las buenas prácticas  
🤝 **Comunicación clara** - Puente entre equipos técnicos y negocio  
...
### 🏆 Conexus Hub - Plataforma Educativa (DAM)
...
**Líder Técnico** | **Equipo:** 4 desarrolladores  
**Logros:**  
✓ Lideré la arquitectura frontend con Vue.js  
✓ Implementé sistema JWT para 500+ usuarios  
✓ Coordiné despliegue en Docker  

**Producción:** [conexushub.cat](https://www.conexushub.cat)
...
**Co-Líder** | **Equipo:** 5 desarrolladores  
**Logros:**  
✓ Diseñé API REST con Laravel  
✓ Mentoría a junior developers  
✓ Optimización de rendimiento en 40%  

**Producción:** [chromaticbond.cat](https://chromaticbond.cat)
